...
module tb_line_buffer_window_3x3;
    ...
    initial begin : test_seq
        automatic bit no_early_window = 1;
        automatic bit row_wrap_pass = 1;
        automatic int valid_win_count = 0;
        automatic int stalled_win_count = 0;
        automatic bit stress_pass = 1;
        automatic logic [7:0] frame [624:0];
        automatic logic [7:0] img [24:0][24:0];
        ...
        for (int r = 0; r < 25; r++) begin
            for (int c = 0; c < 25; c++) begin
                ...
                if (window_valid) begin
                    automatic int wr = out_row;
                    automatic int wc = out_col;
